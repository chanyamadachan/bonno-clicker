...
export const ACH=[
  ...
  {id:"g1",n:"合掌",d:"最初の発生源を1つ得る",k:1,c:s=>ownAt(s,0)>=1},{id:"p2",n:"塵も積もれば",d:"煩悩を500ためる",k:1,c:s=>s.total>=500},
  {id:"sa1",n:"お賽銭",d:"2番目の発生源を1つ得る",k:1,c:s=>ownAt(s,1)>=1},{id:"c2",n:"除夜の鐘",d:"108回たたく",k:2,c:s=>s.clicks>=108},
  {id:"up1",n:"はじめての学び",d:"学びを1つ得る",k:1,c:s=>upgCount()>=1},{id:"p3",n:"煩悩まみれ",d:"煩悩を5,000ためる",k:1,c:s=>s.total>=5000},
  {id:"om1",n:"すがる心",d:"3番目の発生源を1つ得る",k:1,c:s=>ownAt(s,2)>=1},{id:"f1",n:"御縁",d:"御縁玉でフィーバー発動",k:2,c:s=>s.feversDone>=1},
  ...
  {id:"mk1",n:"漆塗り",d:"木魚が漆塗りに変化",k:2,c:s=>s.total>=1e4},{id:"ju1",n:"百八の珠",d:"4番目の発生源を1つ得る",k:1,c:s=>ownAt(s,3)>=1},
  {id:"r1",n:"初転生",d:"はじめて転生する",k:3,c:s=>s.rebirths>=1},{id:"p5",n:"一切皆苦",d:"煩悩を500,000ためる",k:3,c:s=>s.total>=500000},
  {id:"ga1",n:"餓えの化身",d:"6番目の発生源を1つ得る",k:3,c:s=>ownAt(s,5)>=1},{id:"k15",n:"業が深い",d:"業を15ためる",k:2,c:s=>s.gou>=15},
  ...
  {id:"hy",n:"大法要",d:"大法要の御縁玉を掴む",k:4,c:s=>s.houyous>=1},{id:"low",n:"衆生済度",d:"下位発生源を合計200所持",k:4,c:s=>activeLowids().reduce((a,i)=>a+s.own[i],0)>=200},
  ...
  {id:"jg",n:"地獄めぐり",d:"8番目の発生源を1つ得る",k:4,c:s=>ownAt(s,7)>=1},{id:"mk3",n:"百鬼の器",d:"木魚が百鬼に変化",k:5,c:s=>s.total>=1e10},
  {id:"full",n:"煩悩フルコース",d:"全ての発生源を1つ以上",k:6,c:s=>activeBuildings().every(b=>s.own[b.id]>=1)},
